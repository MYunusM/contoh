...
$b = mysqli_fetch_array(mysqli_query($conect, "SELECT * from tb_pegawai where nik='$id' "));
...
if(isset($_POST['submit'])){
    if($nik == ""){
      ...
      $nama_error = "<span style='color:red;'>Nama Wajib Diisi</span>";
        ...
        $sql = mysqli_query($conect, "UPDATE tb_pegawai set nik='$nik', nama='$nama', kode_bagian='$kode_bagian', masa_kerja='$masa_kerja', gaji='$gaji' where nik='$id'");
        if($sql){
...
<br><br>
        <form action="" method="post" enctype="multipart/form-data">
          <table>
            ...
            <td>Kode Bagian</td>
            <td>
                <input type="text" name="kode_bagian" placeholder="Kode Bagian" class="input" value="<?= $b['kode_bagian'];?>">
                <?= $kode_bagian_error;?>  
            </td></tr>
            <tr>
            <td>Masa Kerja</td>
            <td>
                <input type="text" name="masa_kerja" placeholder="Masa Kerja" class="input" value="<?= $b['masa_kerja'];?>">
                <?= $masa_kerja_error;?>  
            </td></tr>
            <tr>
            <td>Gaji</td>
